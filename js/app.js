...
let wrapper = document.querySelector('.wrapper');// общий блок свайпер-скрола



let pageSlider = new Swiper('.swiper-scroll', {
	// Свои классы
	wrapperClass: "swiper-scroll__conteiner",// общая оболочка слайдов
	slideClass: "swiper-scroll-slide",// слайд свайпера
	...
	pagination: {
		el: '.swiper-scroll__pagination',
		type: 'bullets',
		clickable: true,
		bulletClass: "swiper-scroll__bullet",
		bulletActiveClass: "swiper-scroll__bullet_active",
	},
	// Скролл
	scrollbar: {
		el: '.swiper-scroll__scroll',
		dragClass: "swiper-scroll__drag-scroll",
...
function setScrollType() {
	...
	for (let index = 0; index < pageSlider.slides.length; index++) {
		...
		const pageSlideContent = pageSlide.querySelector('.swiper-scroll-slide__slide-body');
		if (pageSlideContent) {
...
pageSlider.init();
	...
	// // до бавление / удаление класса для убирание падинга при прокрутке
	// let pading = wrapper.classList.contains('_free');

	// //console.log(pading);
	// if (pading == true) {
	// 	swipBody.classList.add('_pading..');
	// 	//console.log("yess pading");
	// }
	// else {
	// 	swipBody.classList.remove('_pading..');
	// 	//console.log("not pading");
	// }
